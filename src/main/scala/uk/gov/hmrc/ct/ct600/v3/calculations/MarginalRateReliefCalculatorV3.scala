...
import uk.gov.hmrc.ct.ct600.v3.{B315, B335, B385}


trait MarginalRateReliefCalculatorV3 extends CtTypeConverters with NumberRounding {

  def computeMarginalRateReliefV3(b315: B315, b335: B335, b385: B385, b39: B39, accountingPeriod: HmrcAccountingPeriod): CATO05 = {
    ...
    val fy1Result = calculateForFinancialYear(fy1,b335, b315, b39, accountingPeriod, constantsForTaxYear(TaxYear(fy1)))

    val fy2Result = if (fy2 != fy1) {
                      calculateForFinancialYear(fy2,b385, b315, b39, accountingPeriod, constantsForTaxYear(TaxYear(fy2)))
                    } else BigDecimal(0)

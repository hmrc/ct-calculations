...
case class B360(value: BigDecimal) extends CtBoxIdentifier("Tax FY1") with CtBigDecimal

object B360 extends CorporationTaxCalculator with Calculated[B360, CT600BoxRetriever] {

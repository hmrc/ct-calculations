...
case class B975(value: Option[String]) extends CtBoxIdentifier("Declaration name") with CtOptionalString with Input with ValidatableBox[CT600DeclarationBoxRetriever] {

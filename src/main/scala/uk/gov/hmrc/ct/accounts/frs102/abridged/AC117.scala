...
import uk.gov.hmrc.ct.accounts.frs102.abridged.calculations.IntangibleAssetsCalculator
...
object AC117 extends Calculated[AC117, AbridgedAccountsBoxRetriever]
  with IntangibleAssetsCalculator {

  override def calculate(boxRetriever: AbridgedAccountsBoxRetriever): AC117 = {

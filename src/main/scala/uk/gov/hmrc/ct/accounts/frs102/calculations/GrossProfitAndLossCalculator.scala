...
trait GrossProfitAndLossCalculator  extends DebitAwareCalculation {
  ...
  def calculateAC24Full(ac12: AC12, ac401: AC401, ac14: AC14, ac403: AC403): AC24 = {
    sum(ac12, ac401, ac14, ac403)(AC24.apply)
  }
  ...
  def calculateAC25Full(ac13: AC13, ac402: AC402, ac15: AC15, ac404: AC404): AC25 = {
    sum(ac13, ac402, ac15, ac404)(AC25.apply)
  }

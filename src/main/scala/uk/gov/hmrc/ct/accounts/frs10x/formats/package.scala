...
package object formats {
  ...
  implicit val ac8081Format: OptionalBooleanFormat[AC8081] = new OptionalBooleanFormat(AC8081.apply)
  implicit val ac8082Format: OptionalBooleanFormat[AC8082] = new OptionalBooleanFormat(AC8082.apply)
  implicit val ac8083Format: OptionalBooleanFormat[AC8083] = new OptionalBooleanFormat(AC8083.apply)
  implicit val ac8088Format: OptionalBooleanFormat[AC8088] = new OptionalBooleanFormat(AC8088.apply)
  implicit val ac8089Format: OptionalBooleanFormat[AC8089] = new OptionalBooleanFormat(AC8089.apply)

  implicit val ac401Format: OptionalIntegerFormat[AC401] = new OptionalIntegerFormat[AC401](AC401.apply)
  implicit val ac402Format: OptionalIntegerFormat[AC402] = new OptionalIntegerFormat[AC402](AC402.apply)
  implicit val ac403Format: OptionalIntegerFormat[AC403] = new OptionalIntegerFormat[AC403](AC403.apply)
  implicit val ac404Format: OptionalIntegerFormat[AC404] = new OptionalIntegerFormat[AC404](AC404.apply)

  implicit val acq8161Format: OptionalBooleanFormat[ACQ8161] = new OptionalBooleanFormat[ACQ8161](ACQ8161.apply)

...
object AC81 extends Calculated[AC81, AbridgedAccountsBoxRetriever] with TotalShareholdersFundsCalculator {

  override def calculate(boxRetriever: AbridgedAccountsBoxRetriever): AC81 = {

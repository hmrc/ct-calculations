...
import uk.gov.hmrc.ct.box.{CtBoxIdentifier, CtOptionalString, CtValidation, Input, ValidatableBox}
import uk.gov.hmrc.ct.computations.retriever.ComputationsBuildingsBoxRetriever

case class SBA01B(value: Option[String]) extends CtBoxIdentifier(name = "Building postcode")

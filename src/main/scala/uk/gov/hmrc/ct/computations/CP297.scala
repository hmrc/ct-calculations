...
object CP297 extends Calculated[CP297, ComputationsBuildingsBoxRetriever] with SBACalculator {
  override def calculate(boxRetriever: ComputationsBuildingsBoxRetriever): CP297 = {

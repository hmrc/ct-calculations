...
package uk.gov.hmrc.ct.ct600.v2.stubs
...
import uk.gov.hmrc.ct.ct600.v2.{B1000, B42, B42b, B84, _}
...
trait StubbedCT600BoxRetriever extends CT600BoxRetriever with StubbedAccountsBoxRetriever with StubbedFilingAttributesBoxValueRetriever {
  ...
  override def retrieveB38(): B38 = ???

  override def retrieveB39(): B39 = ???

  override def retrieveB1000: B1000 = ???

  override def retrieveB42b(): B42b = ???

  override def retrieveB91(): B91 = ???

  override def retrieveB155(): B155 = ???

  override def retrieveB42a(): B42a = ???

  override def retrieveB84(): B84 = ???

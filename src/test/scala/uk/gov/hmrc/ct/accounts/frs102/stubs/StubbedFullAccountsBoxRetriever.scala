...
import uk.gov.hmrc.ct.accounts.{AC1, AC12, AC14, AC2, AC205, AC206, AC3, AC4, AC401, AC402, AC403, AC404, CompanyAddress}
...
trait StubbedFullAccountsBoxRetriever extends FullAccountsBoxRetriever with FilingAttributesBoxValueRetriever{
  ...
  override def ac16(): AC16 = ???

  override def ac17(): AC17 = ???

...
class AC76Spec extends AccountsMoneyValidationFixture[Frs102AccountsBoxRetriever]
  ...
  testAccountsRequiredValidation("AC76", AC76.apply, boxRetriever.ac77, AC77.apply, boxRetriever)
}

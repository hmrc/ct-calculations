...
class AC107Spec extends AccountsMoneyValidationFixture with MockAbridgedAccountsRetriever {
  ...
  testAccountsMoneyValidationWithMinMaxIgnoringEmptyTest("AC107", 0, 99999, AC107.apply)

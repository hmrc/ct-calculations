...
class AC74Spec extends AccountsMoneyValidationFixture[Frs102AccountsBoxRetriever]
  with AccountsRequiredValidationFixture[Frs102AccountsBoxRetriever]
  with MockFrs102AccountsRetriever {
  when(boxRetriever.ac75()).thenReturn(AC75(None))
  testAccountsMoneyValidation("AC74", AC74.apply)
  testAccountsRequiredValidation("AC74", AC74.apply, boxRetriever.ac75, AC75.apply, boxRetriever)
}

...
class CP7Spec extends WordSpec with Matchers with MockitoSugar {
  ...
  "CP7 validation" should {
    ...
    "HMRC only charity/CASC filing" when {
      ...
      val testTable = Table(
        ...
        ("2015-01-01",     "2015-12-31",     false,             6500001,              "error.CP7.hmrc.turnover.above.max",      "1 year AP pre FRS with above max value NOT abridged"),
        ("2015-01-01",     "2015-12-31",     true,              6500001,              "error.CP7.hmrc.turnover.above.max",      "1 year AP pre FRS with above max value abridged"),
        ("2015-01-01",     "2015-12-31",     false,             -6500001,             "error.CP7.hmrc.turnover.below.min",      "1 year AP pre FRS with below min value NOT abridged"),
        ("2015-01-01",     "2015-12-31",     true,              -6500001,             "error.CP7.hmrc.turnover.below.min",      "1 year AP pre FRS with below min value abridged"),
        ...
        ("2017-01-01",     "2017-12-31",     false,             6500001,              "error.CP7.hmrc.turnover.above.max",      "1 year AP post FRS with above max value NOT abridged"),
        ("2017-01-01",     "2017-12-31",     true,              6500001,              "error.CP7.hmrc.turnover.above.max",      "1 year AP post FRS with above max value abridged"),
        ("2017-01-01",     "2017-12-31",     false,             -6500001,             "error.CP7.hmrc.turnover.below.min",      "1 year AP post FRS with below min value NOT abridged"),
        ("2017-01-01",     "2017-12-31",     true,              -6500001,             "error.CP7.hmrc.turnover.below.min",      "1 year AP post FRS with below min value abridged"),
        ...
        ("2016-01-01",     "2016-12-31",     false,             6500001,              "error.CP7.hmrc.turnover.above.max",      "1 year AP FRS with above max value NOT abridged"),
        ("2016-01-01",     "2016-12-31",     true,              6500001,              "error.CP7.hmrc.turnover.above.max",      "1 year AP FRS with above max value abridged"),
        ("2016-01-01",     "2016-12-31",     false,             -6500001,             "error.CP7.hmrc.turnover.below.min",      "1 year AP FRS with below min value NOT abridged"),
        ("2016-01-01",     "2016-12-31",     true,              -6500001,             "error.CP7.hmrc.turnover.below.min",      "1 year AP FRS with below min value abridged"),
        ...
        ("2015-07-01",     "2016-12-31",     false,             9767760,              "error.CP7.hmrc.turnover.above.max",      "18 month with leap year pre AP FRS with above max value NOT abridged"),
        ("2015-07-01",     "2016-12-31",     true,              9767760,              "error.CP7.hmrc.turnover.above.max",      "18 month with leap year pre AP FRS with above max value abridged"),
        ("2015-07-01",     "2016-12-31",     false,             -9767760,             "error.CP7.hmrc.turnover.below.min",      "18 month with leap year pre AP FRS with below min value NOT abridged"),
        ("2015-07-01",     "2016-12-31",     true,              -9767760,             "error.CP7.hmrc.turnover.below.min",      "18 month with leap year pre AP FRS with below min value abridged"),
        ...
        ("2019-07-01",     "2020-12-31",     false,             9767760,              "error.CP7.hmrc.turnover.above.max",      "18 month with leap year AP post FRS with above max value NOT abridged"),
        ("2019-07-01",     "2020-12-31",     true,              9767760,              "error.CP7.hmrc.turnover.above.max",      "18 month with leap year AP post FRS with above max value abridged"),
        ("2019-07-01",     "2020-12-31",     false,             -9767760,             "error.CP7.hmrc.turnover.below.min",      "18 month with leap year AP post FRS with below min value NOT abridged"),
        ("2019-07-01",     "2020-12-31",     true,              -9767760,             "error.CP7.hmrc.turnover.below.min",      "18 month with leap year AP post FRS with below min value abridged"),
        ...
        ("2014-07-01",     "2015-12-31",     false,             9776713,              "error.CP7.hmrc.turnover.above.max",      "18 month with non leap year pre AP FRS with above max value NOT abridged"),
        ("2014-07-01",     "2015-12-31",     true,              9776713,              "error.CP7.hmrc.turnover.above.max",      "18 month with non leap year pre AP FRS with above max value abridged"),
        ("2014-07-01",     "2015-12-31",     false,             -9776713,             "error.CP7.hmrc.turnover.below.min",      "18 month with non leap year pre AP FRS with below min value NOT abridged"),
        ("2014-07-01",     "2015-12-31",     true,              -9776713,             "error.CP7.hmrc.turnover.below.min",      "18 month with non leap year pre AP FRS with below min value abridged"),
        ...
        ("2017-07-01",     "2018-12-31",     false,             9776713,              "error.CP7.hmrc.turnover.above.max",      "18 month with non leap year AP post FRS with above max value NOT abridged"),
        ("2017-07-01",     "2018-12-31",     true,              9776713,              "error.CP7.hmrc.turnover.above.max",      "18 month with non leap year AP post FRS with above max value abridged"),
        ("2017-07-01",     "2018-12-31",     false,             -9776713,             "error.CP7.hmrc.turnover.below.min",      "18 month with non leap year AP post FRS with below min value NOT abridged"),
        ("2017-07-01",     "2018-12-31",     true,              -9776713,             "error.CP7.hmrc.turnover.below.min",      "18 month with non leap year AP post FRS with below min value abridged"),
        ...
        ("2015-12-01",     "2016-05-31",     false,             3250001,              "error.CP7.hmrc.turnover.above.max",      "6 month with leap year pre AP FRS with above max value NOT abridged"),
        ("2015-12-01",     "2016-05-31",     true,              3250001,              "error.CP7.hmrc.turnover.above.max",      "6 month with leap year pre AP FRS with above max value abridged"),
        ("2015-12-01",     "2016-05-31",     false,             -3250001,             "error.CP7.hmrc.turnover.below.min",      "6 month with leap year pre AP FRS with below min value NOT abridged"),
        ("2015-12-01",     "2016-05-31",     true,              -3250001,             "error.CP7.hmrc.turnover.below.min",      "6 month with leap year pre AP FRS with below min value abridged"),
        ...
        ("2020-01-01",     "2020-06-30",     false,             3232241,              "error.CP7.hmrc.turnover.above.max",      "6 month with leap year AP post FRS with above max value NOT abridged"),
        ("2020-01-01",     "2020-06-30",     true,              3232241,              "error.CP7.hmrc.turnover.above.max",      "6 month with leap year AP post FRS with above max value abridged"),
        ("2020-01-01",     "2020-06-30",     false,             -3232241,             "error.CP7.hmrc.turnover.below.min",      "6 month with leap year AP post FRS with below min value NOT abridged"),
        ("2020-01-01",     "2020-06-30",     true,              -3232241,             "error.CP7.hmrc.turnover.below.min",      "6 month with leap year AP post FRS with below min value abridged"),
        ...
        ("2015-07-01",     "2015-12-31",     false,             3276713,              "error.CP7.hmrc.turnover.above.max",      "6 month with non leap year pre AP FRS with above max value NOT abridged"),
        ("2015-07-01",     "2015-12-31",     true,              3276713,              "error.CP7.hmrc.turnover.above.max",      "6 month with non leap year pre AP FRS with above max value abridged"),
        ("2015-07-01",     "2015-12-31",     false,             -3276713,             "error.CP7.hmrc.turnover.below.min",      "6 month with non leap year pre AP FRS with below min value NOT abridged"),
        ("2015-07-01",     "2015-12-31",     true,              -3276713,             "error.CP7.hmrc.turnover.below.min",      "6 month with non leap year pre AP FRS with below min value abridged"),
        ...
        ("2017-07-01",     "2017-12-31",     false,             3276713,              "error.CP7.hmrc.turnover.above.max",      "6 month with non leap year AP post FRS with above max value NOT abridged"),
        ("2017-07-01",     "2017-12-31",     true,              3276713,              "error.CP7.hmrc.turnover.above.max",      "6 month with non leap year AP post FRS with above max value abridged"),
        ("2017-07-01",     "2017-12-31",     false,             -3276713,             "error.CP7.hmrc.turnover.below.min",      "6 month with non leap year AP post FRS with below min value NOT abridged"),
        ("2017-07-01",     "2017-12-31",     true,              -3276713,             "error.CP7.hmrc.turnover.below.min",      "6 month with non leap year AP post FRS with below min value abridged"),
        ...
        ("2016-03-01",     "2017-03-01",     false,             6517809,              "error.CP7.hmrc.turnover.above.max",      "1 year and 1 day AP starting 1 March in leap year post FRS with above max value NOT abridged"),
        ("2016-03-01",     "2017-03-01",     true,              6517809,              "error.CP7.hmrc.turnover.above.max",      "1 year and 1 day AP starting 1 March in leap year post FRS with above max value abridged"),
        ("2016-03-01",     "2017-03-01",     false,             -6517809,             "error.CP7.hmrc.turnover.below.min",      "1 year and 1 day AP starting 1 March in leap year post FRS with below min value NOT abridged"),
        ("2016-03-01",     "2017-03-01",     true,              -6517809,             "error.CP7.hmrc.turnover.below.min",      "1 year and 1 day AP starting 1 March in leap year post FRS with below min value abridged"),
        ...
        ("2019-02-28",     "2020-02-28",     false,             6517809,              "error.CP7.hmrc.turnover.above.max",      "1 year and 1 day AP ending 28 Feb in leap year post FRS with above max value NOT abridged"),
        ("2019-02-28",     "2020-02-28",     true,              6517809,              "error.CP7.hmrc.turnover.above.max",      "1 year and 1 day AP ending 28 Feb in leap year post FRS with above max value abridged"),
        ("2019-02-28",     "2020-02-28",     false,             -6517809,             "error.CP7.hmrc.turnover.below.min",      "1 year and 1 day AP ending 28 Feb in leap year post FRS with below min value NOT abridged"),
        ("2019-02-28",     "2020-02-28",     true,              -6517809,             "error.CP7.hmrc.turnover.below.min",      "1 year and 1 day AP ending 28 Feb in leap year post FRS with below min value abridged"),
        ...
        ("2016-02-29",     "2016-12-31",     false,             5452186,              "error.CP7.hmrc.turnover.above.max",      "short AP starting 29 Feb in leap year post FRS with above max value NOT abridged"),
        ("2016-02-29",     "2016-12-31",     true,              5452186,              "error.CP7.hmrc.turnover.above.max",      "short AP starting 29 Feb in leap year post FRS with above max value abridged"),
        ("2016-02-29",     "2016-12-31",     false,             -5452186,             "error.CP7.hmrc.turnover.below.min",      "short AP starting 29 Feb in leap year post FRS with below min value NOT abridged"),
        ("2016-02-29",     "2016-12-31",     true,              -5452186,             "error.CP7.hmrc.turnover.below.min",      "short AP starting 29 Feb in leap year post FRS with below min value abridged"),
        ...
        ("2019-02-01",     "2020-02-29",     false,             6997268,              "error.CP7.hmrc.turnover.above.max",      "long AP ending 29 Feb in leap year post FRS with above max value NOT abridged"),
        ("2019-02-01",     "2020-02-29",     true,              6997268,              "error.CP7.hmrc.turnover.above.max",      "long AP ending 29 Feb in leap year post FRS with above max value abridged"),
        ("2019-02-01",     "2020-02-29",     false,             -6997268,             "error.CP7.hmrc.turnover.below.min",      "long AP ending 29 Feb in leap year post FRS with below min value NOT abridged"),
        ("2019-02-01",     "2020-02-29",     true,              -6997268,             "error.CP7.hmrc.turnover.below.min",      "long AP ending 29 Feb in leap year post FRS with below min value abridged"),
        ...
        ("2019-06-01",     "2020-05-31",     false,             6500001,              "error.CP7.hmrc.turnover.above.max",      "1 year AP ending in leap year post FRS with above max value NOT abridged"),
        ("2019-06-01",     "2020-05-31",     true,              6500001,              "error.CP7.hmrc.turnover.above.max",      "1 year AP ending in leap year post FRS with above max value abridged"),
        ("2019-06-01",     "2020-05-31",     false,             -6500001,             "error.CP7.hmrc.turnover.below.min",      "1 year AP ending in leap year post FRS with below min value NOT abridged"),
        ("2019-06-01",     "2020-05-31",     true,              -6500001,             "error.CP7.hmrc.turnover.below.min",      "1 year AP ending in leap year post FRS with below min value abridged"),
        ...
        ("2019-03-01",     "2020-02-29",     false,             6500001,              "error.CP7.hmrc.turnover.above.max",      "1 year AP ending 29 Feb in leap year post FRS with above max value NOT abridged"),
        ("2019-03-01",     "2020-02-29",     true,              6500001,              "error.CP7.hmrc.turnover.above.max",      "1 year AP ending 29 Feb in leap year post FRS with above max value abridged"),
        ("2019-03-01",     "2020-02-29",     false,             -6500001,             "error.CP7.hmrc.turnover.below.min",      "1 year AP ending 29 Feb in leap year post FRS with below min value NOT abridged"),
        ("2019-03-01",     "2020-02-29",     true,              -6500001,             "error.CP7.hmrc.turnover.below.min",      "1 year AP ending 29 Feb in leap year post FRS with below min value abridged")
      )
  ...
  private def assertHmrcInvolvedCompanyValidation(isHmrcFiling: Boolean, isCoHoFiling: Boolean): Unit = {
    ...
    val testTable = Table(
      ...
      ("2015-01-01",     "2015-12-31",     false,             632001,              "error.CP7.hmrc.turnover.above.max",      "1 year AP pre FRS with above max value NOT abridged"),
      ("2015-01-01",     "2015-12-31",     true,              632001,              "error.CP7.hmrc.turnover.above.max",      "1 year AP pre FRS with above max value abridged"),
      ("2015-01-01",     "2015-12-31",     false,             -632001,             "error.CP7.hmrc.turnover.below.min",      "1 year AP pre FRS with below min value NOT abridged"),
      ("2015-01-01",     "2015-12-31",     true,              -632001,             "error.CP7.hmrc.turnover.below.min",      "1 year AP pre FRS with below min value abridged"),
      ...
      ("2016-01-01",     "2016-12-31",     false,             632001,              "error.CP7.hmrc.turnover.above.max",      "1 year AP FRS with above max value NOT abridged"),
      ("2016-01-01",     "2016-12-31",     true,              632001,              "error.CP7.hmrc.turnover.above.max",      "1 year AP FRS with above max value abridged"),
      ("2016-01-01",     "2016-12-31",     false,             -632001,             "error.CP7.hmrc.turnover.below.min",      "1 year AP FRS with below min value NOT abridged"),
      ("2016-01-01",     "2016-12-31",     true,              -632001,             "error.CP7.hmrc.turnover.below.min",      "1 year AP FRS with below min value abridged"),
      ...
      ("2015-12-01",     "2016-05-31",     false,             316001,              "error.CP7.hmrc.turnover.above.max",      "6 month with leap year pre AP FRS with above max value NOT abridged"),
      ("2015-12-01",     "2016-05-31",     true,              316001,              "error.CP7.hmrc.turnover.above.max",      "6 month with leap year pre AP FRS with above max value abridged"),
      ("2015-12-01",     "2016-05-31",     false,             -316001,             "error.CP7.hmrc.turnover.below.min",      "6 month with leap year pre AP FRS with below min value NOT abridged"),
      ("2015-12-01",     "2016-05-31",     true,              -316001,             "error.CP7.hmrc.turnover.below.min",      "6 month with leap year pre AP FRS with below min value abridged"),
      ...
      ("2020-01-01",     "2020-06-30",     false,             314274,              "error.CP7.hmrc.turnover.above.max",      "6 month with leap year AP post FRS with above max value NOT abridged"),
      ("2020-01-01",     "2020-06-30",     true,              314274,              "error.CP7.hmrc.turnover.above.max",      "6 month with leap year AP post FRS with above max value abridged"),
      ("2020-01-01",     "2020-06-30",     false,             -314274,             "error.CP7.hmrc.turnover.below.min",      "6 month with leap year AP post FRS with below min value NOT abridged"),
      ("2020-01-01",     "2020-06-30",     true,              -314274,             "error.CP7.hmrc.turnover.below.min",      "6 month with leap year AP post FRS with below min value abridged"),
      ...
      ("2015-07-01",     "2015-12-31",     false,             318598,              "error.CP7.hmrc.turnover.above.max",      "6 month with non leap year pre AP FRS with above max value NOT abridged"),
      ("2015-07-01",     "2015-12-31",     true,              318598,              "error.CP7.hmrc.turnover.above.max",      "6 month with non leap year pre AP FRS with above max value abridged"),
      ("2015-07-01",     "2015-12-31",     false,             -318598,             "error.CP7.hmrc.turnover.below.min",      "6 month with non leap year pre AP FRS with below min value NOT abridged"),
      ("2015-07-01",     "2015-12-31",     true,              -318598,             "error.CP7.hmrc.turnover.below.min",      "6 month with non leap year pre AP FRS with below min value abridged"),
      ...
      ("2017-07-01",     "2017-12-31",     false,             318598,              "error.CP7.hmrc.turnover.above.max",      "6 month with non leap year AP post FRS with above max value NOT abridged"),
      ("2017-07-01",     "2017-12-31",     true,              318598,              "error.CP7.hmrc.turnover.above.max",      "6 month with non leap year AP post FRS with above max value abridged"),
      ("2017-07-01",     "2017-12-31",     false,             -318598,             "error.CP7.hmrc.turnover.below.min",      "6 month with non leap year AP post FRS with below min value NOT abridged"),
      ("2017-07-01",     "2017-12-31",     true,              -318598,             "error.CP7.hmrc.turnover.below.min",      "6 month with non leap year AP post FRS with below min value abridged"),
      ...
      ("2016-02-29",     "2016-12-31",     false,             530121,              "error.CP7.hmrc.turnover.above.max",      "short AP starting 29 Feb in leap year post FRS with above max value NOT abridged"),
      ("2016-02-29",     "2016-12-31",     true,              530121,              "error.CP7.hmrc.turnover.above.max",      "short AP starting 29 Feb in leap year post FRS with above max value abridged"),
      ("2016-02-29",     "2016-12-31",     false,             -530121,             "error.CP7.hmrc.turnover.below.min",      "short AP starting 29 Feb in leap year post FRS with below min value NOT abridged"),
      ("2016-02-29",     "2016-12-31",     true,              -530121,             "error.CP7.hmrc.turnover.below.min",      "short AP starting 29 Feb in leap year post FRS with below min value abridged"),
      ...
      ("2019-06-01",     "2020-05-31",     false,             632001,              "error.CP7.hmrc.turnover.above.max",      "1 year AP ending in leap year post FRS with above max value NOT abridged"),
      ("2019-06-01",     "2020-05-31",     true,              632001,              "error.CP7.hmrc.turnover.above.max",      "1 year AP ending in leap year post FRS with above max value abridged"),
      ("2019-06-01",     "2020-05-31",     false,             -632001,             "error.CP7.hmrc.turnover.below.min",      "1 year AP ending in leap year post FRS with below min value NOT abridged"),
      ("2019-06-01",     "2020-05-31",     true,              -632001,             "error.CP7.hmrc.turnover.below.min",      "1 year AP ending in leap year post FRS with below min value abridged")
    )

...
class CP7Spec extends AnyWordSpec with Matchers with MockitoSugar {
  ...
  "CP7 validation" should {
    ...
    "HMRC only charity/CASC filing" when {
      ...
      val testTable = Table(
        ...
        ("2015-01-01",     "2015-12-31",     false,             -6500000,             "error.CP7.mustBeZeroOrPositive",                                        "1 year AP pre FRS with min value on threshold NOT abridged"),
        ("2015-01-01",     "2015-12-31",     true,              -6500000,             "error.CP7.mustBeZeroOrPositive",                                        "1 year AP pre FRS with min value on threshold abridged"),
        ...
        ("2017-01-01",     "2017-12-31",     false,             -6500000,             "error.CP7.mustBeZeroOrPositive",                                        "1 year AP post FRS with min value on threshold NOT abridged"),
        ("2017-01-01",     "2017-12-31",     true,              -6500000,             "error.CP7.mustBeZeroOrPositive",                                        "1 year AP post FRS with min value on threshold abridged"),
        ...
        ("2016-01-01",     "2016-12-31",     false,             -6500000,             "error.CP7.mustBeZeroOrPositive",                                        "1 year AP FRS with min value on threshold NOT abridged"),
        ("2016-01-01",     "2016-12-31",     true,              -6500000,             "error.CP7.mustBeZeroOrPositive",                                        "1 year AP FRS with min value on threshold abridged"),
        ...
        ("2015-07-01",     "2016-12-31",     false,             -9767759,             "error.CP7.mustBeZeroOrPositive",                                        "18 month with leap year pre AP FRS with min value on threshold NOT abridged"),
        ("2015-07-01",     "2016-12-31",     true,              -9767759,             "error.CP7.mustBeZeroOrPositive",                                        "18 month with leap year pre AP FRS with min value on threshold abridged"),
        ...
        ("2019-07-01",     "2020-12-31",     false,             -9767759,             "error.CP7.mustBeZeroOrPositive",                                        "18 month with leap year AP post FRS with min value on threshold NOT abridged"),
        ("2019-07-01",     "2020-12-31",     true,              -9767759,             "error.CP7.mustBeZeroOrPositive",                                        "18 month with leap year AP post FRS with min value on threshold abridged"),
        ...
        ("2014-07-01",     "2015-12-31",     false,             -9776712,             "error.CP7.mustBeZeroOrPositive",                                        "18 month with non leap year pre AP FRS with min value on threshold NOT abridged"),
        ("2014-07-01",     "2015-12-31",     true,              -9776712,             "error.CP7.mustBeZeroOrPositive",                                        "18 month with non leap year pre AP FRS with min value on threshold abridged"),
        ...
        ("2017-07-01",     "2018-12-31",     false,             -9776712,             "error.CP7.mustBeZeroOrPositive",                                        "18 month with non leap year AP post FRS with min value on threshold NOT abridged"),
        ("2017-07-01",     "2018-12-31",     true,              -9776712,             "error.CP7.mustBeZeroOrPositive",                                        "18 month with non leap year AP post FRS with min value on threshold abridged"),
        ...
        ("2015-12-01",     "2016-05-31",     false,             -3250000,             "error.CP7.mustBeZeroOrPositive",                                        "6 month with leap year pre AP FRS with min value on threshold NOT abridged"),
        ("2015-12-01",     "2016-05-31",     true,              -3250000,             "error.CP7.mustBeZeroOrPositive",                                        "6 month with leap year pre AP FRS with min value on threshold abridged"),
        ...
        ("2020-01-01",     "2020-06-30",     false,             -3232240,             "error.CP7.mustBeZeroOrPositive",                                        "6 month with leap year AP post FRS with min value on threshold NOT abridged"),
        ("2020-01-01",     "2020-06-30",     true,              -3232240,             "error.CP7.mustBeZeroOrPositive",                                        "6 month with leap year AP post FRS with min value on threshold abridged"),
        ...
        ("2015-07-01",     "2015-12-31",     false,             -3276712,             "error.CP7.mustBeZeroOrPositive",                                        "6 month with non leap year pre AP FRS with min value on threshold NOT abridged"),
        ("2015-07-01",     "2015-12-31",     true,              -3276712,             "error.CP7.mustBeZeroOrPositive",                                        "6 month with non leap year pre AP FRS with min value on threshold abridged"),
        ...
        ("2017-07-01",     "2017-12-31",     false,             -3276712,             "error.CP7.mustBeZeroOrPositive",                                        "6 month with non leap year AP post FRS with min value on threshold NOT abridged"),
        ("2017-07-01",     "2017-12-31",     true,              -3276712,             "error.CP7.mustBeZeroOrPositive",                                        "6 month with non leap year AP post FRS with min value on threshold abridged"),
        ...
        ("2016-03-01",     "2017-03-01",     false,             -6517808,             "error.CP7.mustBeZeroOrPositive",                                        "1 year and 1 day AP starting 1 March in leap year post FRS with min value on threshold NOT abridged"),
        ("2016-03-01",     "2017-03-01",     true,              -6517808,             "error.CP7.mustBeZeroOrPositive",                                        "1 year and 1 day AP starting 1 March in leap year post FRS with min value on threshold abridged"),
        ...
        ("2019-02-28",     "2020-02-28",     false,             -6517808,             "error.CP7.mustBeZeroOrPositive",                                        "1 year and 1 day AP ending 28 Feb in leap year post FRS with min value on threshold NOT abridged"),
        ("2019-02-28",     "2020-02-28",     true,              -6517808,             "error.CP7.mustBeZeroOrPositive",                                        "1 year and 1 day AP ending 28 Feb in leap year post FRS with min value on threshold abridged"),
        ...
        ("2016-02-29",     "2016-12-31",     false,             -5452185,             "error.CP7.mustBeZeroOrPositive",                                        "short AP starting 29 Feb in leap year post FRS with min value on threshold NOT abridged"),
        ("2016-02-29",     "2016-12-31",     true,              -5452185,             "error.CP7.mustBeZeroOrPositive",                                        "short AP starting 29 Feb in leap year post FRS with min value on threshold abridged"),
        ...
        ("2019-02-01",     "2020-02-29",     false,             -6997267,             "error.CP7.mustBeZeroOrPositive",                                        "long AP ending 29 Feb in leap year post FRS with min value on threshold NOT abridged"),
        ("2019-02-01",     "2020-02-29",     true,              -6997267,             "error.CP7.mustBeZeroOrPositive",                                        "long AP ending 29 Feb in leap year post FRS with min value on threshold abridged"),
        ...
        ("2019-06-01",     "2020-05-31",     false,             -6500000,             "error.CP7.mustBeZeroOrPositive",                                        "1 year AP ending in leap year post FRS with min value on threshold NOT abridged"),
        ("2019-06-01",     "2020-05-31",     true,              -6500000,             "error.CP7.mustBeZeroOrPositive",                                        "1 year AP ending in leap year post FRS with min value on threshold abridged"),
        ...
        ("2019-03-01",     "2020-02-29",     false,             -6500000,             "error.CP7.mustBeZeroOrPositive",                                        "1 year AP ending 29 Feb in leap year post FRS with min value on threshold NOT abridged"),
        ("2019-03-01",     "2020-02-29",     true,              -6500000,             "error.CP7.mustBeZeroOrPositive",                                        "1 year AP ending 29 Feb in leap year post FRS with min value on threshold abridged"),
  ...
  private def assertHmrcInvolvedCompanyValidation(isHmrcFiling: Boolean, isCoHoFiling: Boolean): Unit = {
    ...
    val testTable = Table(
      ...
      ("2015-01-01",     "2015-12-31",     false,             -632000,             "error.CP7.mustBeZeroOrPositive",                                        "1 year AP pre FRS with min value on threshold NOT abridged"),
      ("2015-01-01",     "2015-12-31",     true,              -632000,             "error.CP7.mustBeZeroOrPositive",                                        "1 year AP pre FRS with min value on threshold abridged"),
      ...
      ("2016-01-01",     "2016-12-31",     false,             -632000,             "error.CP7.mustBeZeroOrPositive",                                        "1 year AP FRS with min value on threshold NOT abridged"),
      ("2016-01-01",     "2016-12-31",     true,              -632000,             "error.CP7.mustBeZeroOrPositive",                                        "1 year AP FRS with min value on threshold abridged"),
      ...
      ("2015-12-01",     "2016-05-31",     false,             -316000,             "error.CP7.mustBeZeroOrPositive",                                        "6 month with leap year pre AP FRS with min value on threshold NOT abridged"),
      ("2015-12-01",     "2016-05-31",     true,              -316000,             "error.CP7.mustBeZeroOrPositive",                                        "6 month with leap year pre AP FRS with min value on threshold abridged"),
      ...
      ("2020-01-01",     "2020-06-30",     false,             -314273,             "error.CP7.mustBeZeroOrPositive",                                        "6 month with leap year AP post FRS with min value on threshold NOT abridged"),
      ("2020-01-01",     "2020-06-30",     true,              -314273,             "error.CP7.mustBeZeroOrPositive",                                        "6 month with leap year AP post FRS with min value on threshold abridged"),
      ...
      ("2015-07-01",     "2015-12-31",     false,             -318597,             "error.CP7.mustBeZeroOrPositive",                                        "6 month with non leap year pre AP FRS with min value on threshold NOT abridged"),
      ("2015-07-01",     "2015-12-31",     true,              -318597,             "error.CP7.mustBeZeroOrPositive",                                        "6 month with non leap year pre AP FRS with min value on threshold abridged"),
      ...
      ("2017-07-01",     "2017-12-31",     false,             -318597,             "error.CP7.mustBeZeroOrPositive",                                        "6 month with non leap year AP post FRS with min value on threshold NOT abridged"),
      ("2017-07-01",     "2017-12-31",     true,              -318597,             "error.CP7.mustBeZeroOrPositive",                                        "6 month with non leap year AP post FRS with min value on threshold abridged"),
      ...
      ("2016-02-29",     "2016-12-31",     false,             -530120,             "error.CP7.mustBeZeroOrPositive",                                        "short AP starting 29 Feb in leap year post FRS with min value on threshold NOT abridged"),
      ("2016-02-29",     "2016-12-31",     true,              -530120,             "error.CP7.mustBeZeroOrPositive",                                        "short AP starting 29 Feb in leap year post FRS with min value on threshold abridged"),
      ...
      ("2019-06-01",     "2020-05-31",     false,             -632000,             "error.CP7.mustBeZeroOrPositive",                                        "1 year AP ending in leap year post FRS with min value on threshold NOT abridged"),
      ("2019-06-01",     "2020-05-31",     true,              -632000,             "error.CP7.mustBeZeroOrPositive",                                        "1 year AP ending in leap year post FRS with min value on threshold abridged"),

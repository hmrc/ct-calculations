...
/*  "NorthernIrelandRateValidation" should {
  ...
  "Losses brought forward from previous period without Northern Ireland rate involved" when {
    ...
    val table = Table(
      ...
      ("Rut's Business",                                          5000,      3000,           Some(true),      AllLossesBroughtForward(Some(10000), Some(3000), Some(7000), None,  Some(7000)),    LossesBroughtForwardAgainstTradingProfit(Some(5000), Some(3000), Some(2000), None,    Some(2000)),     Some(0), Some(5000), Some(0),    Some(5000), LossesBroughtForwardAgainstNonTradingProfit(CP997(None),      CP997c(None), CP997d(None),       CP997e(None))),

...
class CPSuperDeductionOverlapSpec extends AnyWordSpec with MockitoSugar with Matchers with BeforeAndAfter {
  ...
  "CPSuperDeductionOverlap" should {
    ...
    "calculate overlap is true 2" in {
      when(mockRetriever.ac5()).thenReturn(AC5(LocalDate.of(2021,4,1)))
      when(mockRetriever.ac6()).thenReturn(AC6(LocalDate.of(2023,3,31)))
      when(mockRetriever.cp1()).thenReturn(CP1(LocalDate.of(2020,10,1)))
      when(mockRetriever.cp2()).thenReturn(CP2(LocalDate.of(2021,9,30)))
      CPSuperDeductionOverlap.calculate(mockRetriever) shouldBe CPSuperDeductionOverlap(true)
    }
    ...
    "calculate overlap is true 3" in {
      when(mockRetriever.ac5()).thenReturn(AC5(LocalDate.of(2021,4,1)))
      when(mockRetriever.ac6()).thenReturn(AC6(LocalDate.of(2023,3,31)))
      when(mockRetriever.cp1()).thenReturn(CP1(LocalDate.of(2021,10,1)))
      when(mockRetriever.cp2()).thenReturn(CP2(LocalDate.of(2022,9,30)))
      CPSuperDeductionOverlap.calculate(mockRetriever) shouldBe CPSuperDeductionOverlap(true)
    }
    ...
    "calculate overlap is false" in {
      when(mockRetriever.ac5()).thenReturn(AC5(LocalDate.of(2021,4,1)))
      when(mockRetriever.ac6()).thenReturn(AC6(LocalDate.of(2023,3,31)))
      when(mockRetriever.cp1()).thenReturn(CP1(LocalDate.of(2019,10,1)))
      when(mockRetriever.cp2()).thenReturn(CP2(LocalDate.of(2020,9,30)))
    ...
    "calculate overlap is false 2" in {
      when(mockRetriever.ac5()).thenReturn(AC5(LocalDate.of(2021,4,1)))
      when(mockRetriever.ac6()).thenReturn(AC6(LocalDate.of(2023,3,31)))
      when(mockRetriever.cp1()).thenReturn(CP1(LocalDate.of(2023,10,1)))
      when(mockRetriever.cp2()).thenReturn(CP2(LocalDate.of(2024,9,30)))
      CPSuperDeductionOverlap.calculate(mockRetriever) shouldBe CPSuperDeductionOverlap(false)
    }
  }
}
